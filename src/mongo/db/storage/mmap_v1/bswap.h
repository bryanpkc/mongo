...
#  elif defined(__VFP_FP__) || MONGO_CONFIG_BYTE_ORDER == 4321
...
#if MONGO_CONFIG_BYTE_ORDER == 1234 || !defined( ALIGNMENT_IMPORTANT )
...
#if MONGO_CONFIG_BYTE_ORDER == 4321 || !defined( ALIGNMENT_IMPORTANT )
      // This also assumes no alignment issues
